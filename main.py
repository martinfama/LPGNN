...
LPGNN.visualization.gnn_attr_passing.f()

## Plot results, and log

# LPGNN.FullRun.FullRun(graph_type='PS', N=1000, avg_k=20, gamma=2.5, Temp=0.0, seed=100, models=['LaBNE', 'CN', 'GraphSAGE', 'PNA'], epochs=50, 
